...
<?php
include("../../config.php");
if (!isset($_POST['username'])) echo die("Couldn't set username");
if (!isset($_POST['oldPassword']) || !isset($_POST['newPassword1']) || !isset($_POST['newPassword2'])) {
    echo "Not all the feild has been set for the password";
    exit();
}
if ($_POST['oldPassword'] == "" || $_POST['newPassword1'] == "" || $_POST['newPassword2'] == "") {
    echo "Please fill all the password feild";
    exit();
}
...
if (preg_match('/[^A-Za-z0-9]/', $newPassword1)) {
    echo "Your password must only contains letters and numbers";
    exit();
}
