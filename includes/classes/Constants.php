<?php
class Constants {
// added string keyword on 08-01-2021 00:03 (IST)
	public static string $passwordsDoNoMatch = "Your passwords don't match";
	...
	public static string $loginFailed = "username or password was incorrect";
}
?>